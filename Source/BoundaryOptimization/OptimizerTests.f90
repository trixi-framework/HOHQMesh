...
!     ------------------------------------------------------
!
      REAL(KIND=RP) :: targetCuts(0:13) = [0.0000000000000000d0 , 9.7012998027394590D-002,  0.18597895426900293d0, &
...
!
      ...
      REAL(KIND=RP)              :: expectedCuts(0:7) = [0.0000000000000000d0, 8.5660458319249122d-002,  0.17132061069400731d0, &
