...
<p align = "center"> Fig. 18. Simple Extrusion of a semi-circular quadrilateral mesh</p>
...
<p align = "center"> Fig. 19. Simple rotation of the mesh in Fig. 3</p>
...
The rotation angle factor is the fraction of pi over which the quad mesh is rotated. An example is shown above in Fig. 19 of an original two dimensional mesh
...
<p align = "center"> Fig. 20. Hex mesh generated by sweeping a circular mesh along a curve</p>
...
<p align = "center"> Fig. 21. Hex mesh generated by sweeping and scaling along a curve</p>
...
<p align = "center"> Fig. 22. Simple Extrusion of a semi-circular mesh with bottom topography</p>
...
The height function takes two arguments, which are the physical x-y coordinates, unlike the parametric coordinates that define boundary curves. Fig. 22 above shows an example of such a bottom topography.
...
<p align = "center"> Fig. 23. Simple Extrusion of a rectangular mesh with a mountain bottom topography read in from a file</p>
...
<p align = "center"> Fig. 24. Simple Extrusion of a semi-circular mesh with a bottom topography and local refinement depending on its curvature</p>
...
The sizer will then size the grid along the bottom according to the curvature of the topography. An example is shown in Fig. 24.
