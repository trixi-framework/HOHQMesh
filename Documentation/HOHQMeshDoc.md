...
![Circles3](Figures/Circles3.png)<p align = "center"> Fig. 1. Sixth order spectral element mesh of three circles within a circle
...
![Spline](Figures/SplineGeometry.png)<p align = "center"> Fig. 2. Eighth order spectral element mesh of a domain bounded by a spline curve

HOHQMesh has templates to automatically mesh around sharp corners.  

![CavityRamp](Figures/CavityRamp.png)<p align = "center"> Fig. 3. Spectral element mesh of a domain with sharp corners

This makes it possible to mesh airfoil type geometries.

![NACA0012](Figures/NACA0012.png)
<p align = "center"> Fig. 4. Mesh of a NACA0012 airfoil
![KT3Element](Figures/KT3Element.png)<p align = "center"> Fig. 5. Mesh for a three element Karman-Treffiz airfoil

Local refinement can be added manually, either at a point or along a line.
![AllFeatures](Figures/AllFeatures.png)
...
![alt text](Figures/IndianOcean.png)
<p align = "center"> Fig. 7. The Indian Ocean

![alt text](Figures/Superior.png)
...
![alt text](Figures/CavityRampExtruded.png)
...
Finally, swept meshes can also be scaled along the curve.  ScaledSigmoid
...
![alt text](Figures/GingerbreadMan.png)
...
![AllFeatures](Figures/AllFeatures.png)
<p align = "center"> Fig. 14. A mesh whose model uses all curve types. Three *END\_POINTS\_LINE*s for the outer triangle. A *SLPINE\_CURVE* for the free-form inner boundary, and circles defined by a *PARAMETRIC\_EQUATION\_CURVE* and by a *CIRCULAR_ARC* curve.
