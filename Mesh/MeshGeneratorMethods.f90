...
!        ---------------
!
         CLASS(SMChainedCurve)         , POINTER :: boundaryCurve
         CLASS(SMCurve)                , POINTER :: currentCurve
         CLASS(SMNodePtr), DIMENSION(:), POINTER :: nodeArray
         CLASS(SMNode)                 , POINTER :: node
